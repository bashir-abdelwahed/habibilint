...
from habibilint.parse.grammar import (
    BaseGrammar,
)
...
def get_python_modules_in_grammars():
    basepath = os.path.join(os.getcwd(), "habibilint/parse/grammars")
    return [
        (x, convert_filename_to_module(os.path.join("habibilint/parse/grammars", x)))
