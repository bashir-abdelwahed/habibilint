"""A utility for measuring performance characteristics for habibilint.
...
from habibilint.docstring.base import (
    BaseDocstring,
)
from habibilint.docstring.docstring import (
    Docstring,
)
from habibilint.driver import (
    print_version,
)
...
class Performance(object):
    """Measure and report on performance of habibilint."""
    ...
    def _read_and_measure(self, filename):
        ...
        try:
            completed_process = subprocess.run(
                ["habibilint", filename], stdout=subprocess.PIPE
            )
